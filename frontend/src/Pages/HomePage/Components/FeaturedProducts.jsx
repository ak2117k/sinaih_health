...
const FeaturedProducts = () => {
  const products = [
    {
      imgurl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtiaSQKE6xQOtK5VpEW5wV12veiDYIYWdjfA&s",
    ...
    {
      imgurl:
        "https://kaamrajcapsule.com/cdn/shop/files/time69.png?v=1719527855&widt…",
      name: "Time 69",
    },
    {
      imgurl:
        "https://cdn.shopaccino.com/rabbaniunani/products/img20230825121950cc-2-179956_l.png?v=523",
      name: "New Shama Kamini Vidrawan Ras",
    },
  ];
  ...
  return (
    <div>
      <div className=" flex justify-between mt-10 w-full ">
        <h1 className=" text-2xl p-2 ml-10 font-semibold">Featured Products</h1>
